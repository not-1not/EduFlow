...
// ClassCalendar - untuk tracking kehadiran per bulan per kelas
...
// MonthlyPaymentSummary - ringkasan per bulan per siswa
...
// KAS Transaction (extends existing ClassCashTransaction with additional fields)
export interface KASTransaction extends ClassCashTransaction {
  linkedSummaryId?: string; // reference to MonthlyPaymentSummary
  paymentId?: string; // reference to StudentPayment
